 ...
 * @since 9.3
 */
public class AuditEventListener implements EventListener, Synchronization {
    ...
    protected void writeEntry(LogEntry entry) {
        ...
        MQAppender<Record> appender = service.getManager(STREAM_CONFIG).getAppender(STREAM_NAME);
        appender.append(0, Record.of(String.valueOf(entry.getId()), json.getBytes()));
    }
